...
# HDF handling - lazy loaded to avoid importing optional geo dependencies
_HDF_EXPORTS = {
    'HdfBase', 'HdfUtils', 'HdfPlan',
    'HdfMesh', 'HdfXsec', 'HdfBndry', 'HdfStruc', 'HdfHydraulicTables',
    'HdfResultsPlan', 'HdfResultsMesh', 'HdfResultsXsec',
    'HdfResultsBreach', 'HdfPipe', 'HdfPump', 'HdfInfiltration',
    'HdfPlot', 'HdfResultsPlot', 'HdfFluvialPluvial',
...
def __getattr__(name):
    ...
    if name in _HDF_EXPORTS:
        from . import hdf
        return getattr(hdf, name)
